...
CatalogController.add_document_action(:folder, partial: 'blacklight/folders/show/add_to_folder', if: Proc.new { |ctx| ctx.current_ability.can?(:create, Blacklight::Folders::Folder) } )
